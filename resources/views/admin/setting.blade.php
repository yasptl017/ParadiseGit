                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
    <a class="nav-link" id="defaults-tab" data-toggle="tab" href="#defaultsTab" role="tab" aria-controls="defaultsTab" aria-selected="false">{{__('admin.Defaults')}}</a>
</li>
                                ...
                                <div class="col-12 col-sm-12 col-md-9">
                                    <div class="border rounded">
                                        <div class="tab-content no-padding" id="settingsContent">
                                            ...
                                            <div class="tab-pane fade" id="defaultsTab" role="tabpanel" aria-labelledby="defaults-tab">
                                            <div class="card m-0">
    <div class="card-body">
        <form action="{{ route('admin.update-defaults') }}" method="POST">
            @csrf
            @method('PUT')
            <div class="form-group">
