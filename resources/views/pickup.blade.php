                        ...
                        <div class="pay-order-summary">
                            <div class="pay-summary-row">
                                ...
                                <div class="pay-summary-amounts pay-summary-total">
                                    ...
                                    <span class="pay-summary-val pay-grand-total" id="pay-modal-grand-total">{{ $currency_icon }}{{ number_format($sub_total - $coupon_price, 2) }}</span>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    (function ($) {
        ...
        function renderOfferAmounts(response) {
            ...
            var totalText = '{{ $currency_icon }}' + response.grand_total_base.toFixed(2);
